    ...
    <el-form ref="form" label-width="80px">
      ...
      <el-form-item label="销售属性">
        <el-form :inline="true" ref="form" label-width="80px">
          <el-form-item :label="saleAttr.saleAttrName" v-for="(saleAttr,index) in spuSaleAttrList" :key="saleAttr.id">
            <el-select placeholder="请选择" value="" v-model="saleAttr.attrIdAndValueId">
      ...
      <el-form-item label="图片列表">
        <el-table style="width: 100%" border :data="spuImageList" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="imaName" label="名称" width="width">
          </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      spu:{},
      // 收集图片的数据字段,但是，当前收集的数据中，缺少isDefault字段，将来提交给服务器数据的时候，需要整理参数
      imageList:[]
    };
  },
  methods: {
    ...
    handleSelectionChange(params){
      ...
      // 获取到用户选中图片的信息数据，但是，当前收集的数据中，缺少isDefault字段
