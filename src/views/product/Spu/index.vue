  ...
  <div>
    ...
    <el-dialog :title="`${spu.spuName}的SKU列表`" :visible.sync="dialogTableVisible" :before-close="close">
      ...
      <el-table :data="skuList" style="width:100%" border v-loading="loading">
        ...
        <el-table-column prop="weigght" label="重量" width="width"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      scene:0,//0代表展示SPU列表数据   1:代表添加spu|修改spu   2：代表添加sku
      dialogTableVisible:false,//控制对话框的控制与隐藏
      spu:{},
  ...
  methods: {
    ...
    //   this.getSpuList();
    // },
    // 三级联动的回调，可以把子组件的id传递给父组件
    getCategoryId({ categoryId, level }) {
      // categoryId: 获取到一、二、三级分类的id   level：为了区分几级id
      if (level == 1) {
